...
type SharedInformerFactory interface {
	...
	Volumesnapshot() volumesnapshotexternalstoragek8sio.Interface
}

func (f *sharedInformerFactory) Volumesnapshot() volumesnapshotexternalstoragek8sio.Interface {
	return volumesnapshotexternalstoragek8sio.New(f, f.namespace, f.tweakListOptions)
}
