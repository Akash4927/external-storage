...
type VolumeSnapshotDatasGetter interface {
	VolumeSnapshotDatas(namespace string) VolumeSnapshotDataInterface
}
...
func newVolumeSnapshotDatas(c *VolumesnapshotV1Client, namespace string) *volumeSnapshotDatas {
