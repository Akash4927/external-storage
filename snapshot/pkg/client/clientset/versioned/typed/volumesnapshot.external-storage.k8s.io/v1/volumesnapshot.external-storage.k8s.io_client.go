...
import (
	"github.com/akash4927/external-storage/snapshot/pkg/client/clientset/versioned/scheme"
...
func (c *VolumesnapshotV1Client) VolumeSnapshotDatas(namespace string) VolumeSnapshotDataInterface {
	return newVolumeSnapshotDatas(c, namespace)
}
